...
{
    public function __construct(private Ciudades $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?Ciudades
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): Ciudades
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?Ciudades
    {
    ...
    public function delete(int $id): ?Ciudades
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
