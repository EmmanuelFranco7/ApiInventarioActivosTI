...
{
    public function __construct(private CategoriaActivo $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?CategoriaActivo
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): CategoriaActivo
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?CategoriaActivo
    {
    ...
    public function delete(int $id): ?CategoriaActivo
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
