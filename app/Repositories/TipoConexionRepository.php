...
class TipoConexionRepository
{{
    public function __construct(private TipoConexion $model) {{}}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoConexion
    {{
        return $this->model->select($fields)->find($id);
    }}

    public function create(array $data): TipoConexion
    {{
        return $this->model->create($data);
    }}

    public function update(int $id, array $data): ?TipoConexion
    {{
    ...
    public function delete(int $id): ?TipoConexion
    {{
        $entity = $this->model->find($id);
        if ($entity) {{
            $entity->delete();
