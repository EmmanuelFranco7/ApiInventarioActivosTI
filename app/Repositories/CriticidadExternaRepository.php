...
use App\Models\CriticidadExterna;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class CriticidadExternaRepository
{
    public function __construct(private CriticidadExterna $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?CriticidadExterna
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): CriticidadExterna
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?CriticidadExterna
    {
    ...
    public function delete(int $id): ?CriticidadExterna
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
