...
use App\Models\ValorDisponibilidad;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ValorDisponibilidadRepository
{
    public function __construct(private ValorDisponibilidad $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?ValorDisponibilidad
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ValorDisponibilidad
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ValorDisponibilidad
    {
    ...
    public function delete(int $id): ?ValorDisponibilidad
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
