...
use App\Models\TipoProcesoNegocio;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class TipoProcesoNegocioRepository
{
    public function __construct(private TipoProcesoNegocio $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoProcesoNegocio
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): TipoProcesoNegocio
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?TipoProcesoNegocio
    {
    ...
    public function delete(int $id): ?TipoProcesoNegocio
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
