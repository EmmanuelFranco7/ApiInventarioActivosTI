...
use App\Models\TipoUsuarioFinal;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class TipoUsuarioFinalRepository
{
    public function __construct(private TipoUsuarioFinal $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoUsuarioFinal
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): TipoUsuarioFinal
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?TipoUsuarioFinal
    {
    ...
    public function delete(int $id): ?TipoUsuarioFinal
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
