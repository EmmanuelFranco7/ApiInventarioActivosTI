...
use App\Models\ActivosOportunidadesMejora;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ActivosOportunidadesMejoraRepository
{
    public function __construct(private ActivosOportunidadesMejora $model)
    {}
    ...
    public function find(int $id, array $fields = ['*']): ?ActivosOportunidadesMejora
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ActivosOportunidadesMejora
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ActivosOportunidadesMejora
    {
    ...
    public function delete(int $id): ?ActivosOportunidadesMejora
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
