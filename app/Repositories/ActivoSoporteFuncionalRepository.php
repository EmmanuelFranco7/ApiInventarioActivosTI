...
use App\Models\ActivoSoporteFuncional;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ActivoSoporteFuncionalRepository
{
    public function __construct(private ActivoSoporteFuncional $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?ActivoSoporteFuncional
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ActivoSoporteFuncional
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ActivoSoporteFuncional
    {
    ...
    public function delete(int $id): ?ActivoSoporteFuncional
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
