...
use App\Models\ValorConfidencialidad;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ValorConfidencialidadRepository
{
    public function __construct(private ValorConfidencialidad $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?ValorConfidencialidad
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ValorConfidencialidad
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ValorConfidencialidad
    {
    ...
    public function delete(int $id): ?ValorConfidencialidad
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
