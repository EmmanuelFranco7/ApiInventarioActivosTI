...
{
    public function __construct(private Proveedores $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?Proveedores
    {
    ...
    public function update(int $id, array $data): ?Proveedores
    {
    ...
    public function delete(int $id): ?Proveedores
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
