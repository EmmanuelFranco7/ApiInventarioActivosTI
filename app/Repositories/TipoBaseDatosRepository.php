...
use App\Models\TipoBaseDatos;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class TipoBaseDatosRepository
{
    public function __construct(private TipoBaseDatos $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoBaseDatos
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): TipoBaseDatos
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?TipoBaseDatos
    {
    ...
    public function delete(int $id): ?TipoBaseDatos
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
