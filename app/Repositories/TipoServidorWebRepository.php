...
use App\Models\TipoServidorWeb;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class TipoServidorWebRepository
{
    public function __construct(private TipoServidorWeb $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoServidorWeb
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): TipoServidorWeb
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?TipoServidorWeb
    {
    ...
    public function delete(int $id): ?TipoServidorWeb
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
