...
class SistemaOperativoRepository
{
    public function __construct(private SistemaOperativo $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?SistemaOperativo
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): SistemaOperativo
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?SistemaOperativo
    {
    ...
    public function delete(int $id): ?SistemaOperativo
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
