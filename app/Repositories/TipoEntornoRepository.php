...
class TipoEntornoRepository
{{
    public function __construct(private TipoEntorno $model) {{}}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoEntorno
    {{
        return $this->model->select($fields)->find($id);
    }}

    public function create(array $data): TipoEntorno
    {{
        return $this->model->create($data);
    }}

    public function update(int $id, array $data): ?TipoEntorno
    {{
    ...
    public function delete(int $id): ?TipoEntorno
    {{
        $entity = $this->model->find($id);
        if ($entity) {{
            $entity->delete();
