...
class TipoAdquisicionRepository
{{
    public function __construct(private TipoAdquisicion $model) {{}}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoAdquisicion
    {{
        return $this->model->select($fields)->find($id);
    }}

    public function create(array $data): TipoAdquisicion
    {{
        return $this->model->create($data);
    }}

    public function update(int $id, array $data): ?TipoAdquisicion
    {{
    ...
    public function delete(int $id): ?TipoAdquisicion
    {{
        $entity = $this->model->find($id);
        if ($entity) {{
            $entity->delete();
