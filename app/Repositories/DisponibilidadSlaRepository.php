...
use App\Models\DisponibilidadSla;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;

class DisponibilidadSlaRepository
{
    public function __construct(private DisponibilidadSla $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?DisponibilidadSla
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): DisponibilidadSla
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?DisponibilidadSla
    {
    ...
    public function delete(int $id): ?DisponibilidadSla
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
