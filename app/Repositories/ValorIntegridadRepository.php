...
use App\Models\ValorIntegridad;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ValorIntegridadRepository
{
    public function __construct(private ValorIntegridad $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?ValorIntegridad
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ValorIntegridad
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ValorIntegridad
    {
    ...
    public function delete(int $id): ?ValorIntegridad
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
