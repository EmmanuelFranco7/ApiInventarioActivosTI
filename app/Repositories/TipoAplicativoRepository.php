...
use App\Models\TipoAplicativo;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class TipoAplicativoRepository
{
    public function __construct(private TipoAplicativo $model) {}
    ...
    public function find(int $id, array $fields = ['*']): ?TipoAplicativo
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): TipoAplicativo
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?TipoAplicativo
    {
    ...
    public function delete(int $id): ?TipoAplicativo
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
