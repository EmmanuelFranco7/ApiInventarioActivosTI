...
use App\Models\ActivosInformacion;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ActivosInformacionRepository
{
    public function __construct(private ActivosInformacion $model)
    {}
    ...
    public function find(int $id, array $fields = ['*']): ?ActivosInformacion
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ActivosInformacion
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ActivosInformacion
    {
    ...
    public function delete(int $id): ?ActivosInformacion
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
