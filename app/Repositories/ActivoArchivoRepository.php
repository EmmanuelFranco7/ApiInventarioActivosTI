...
use App\Models\ActivoArchivo;
use App\DTO\GetAllParams;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\ModelNotFoundException;

class ActivoArchivoRepository
{
    public function __construct(private ActivoArchivo $model)
    {}
    ...
    public function find(int $id, array $fields = ['*']): ?ActivoArchivo
    {
        return $this->model->select($fields)->find($id);
    }

    public function create(array $data): ActivoArchivo
    {
        return $this->model->create($data);
    }

    public function update(int $id, array $data): ?ActivoArchivo
    {
    ...
    public function delete(int $id): ?ActivoArchivo
    {
        $entity = $this->model->find($id);
        if ($entity) {
            $entity->delete();
